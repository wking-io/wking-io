      ...
      <div className="flex flex-col w-full lg:flex-row font-sans">
        <div className="bg-black text-white lg:max-w-xl p-12">
          ...
          <p className="text-grey-300 leading-relaxed mb-12">
            Feeling pretty passionate about this. Elm is great and there are so many unexplored use cases. As a member
            of both communities I want to step up and give a new group of developers a compelling reason and the right
            tools to bring Elm into their development workflow.
          </p>
          <p>
          ...
          <div className="max-w-5xl w-full mx-auto">
            <div className="flex flex-col md:flex-row mb-12">
              <p className="mb-6 md:mb-0 md:mr-6 leading-relaxed flex-1">
                I solve problems associated with creating digital products. I have spent a lot of my time focusing on
                the transition from design to frontend development, but honestly I just love learning as much as I can
                to better understand how to build successful products.
              </p>
              <p className="md:ml-6 leading-relaxed flex-1">
                ...
                , and I am currently looking into bringing Elm into the Wordpress community. If you would like updates
                on new articles or any of my Elm project subscribe to updates below!
              </p>
            </div>
            <NewsletterInput />
          </div>
