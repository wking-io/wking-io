  ...
  <Layout>
    ...
    <div className="mt-32 min-h-screen max-w-2xl mx-auto text-black font-sans px-8 mb-20">
      <div className="">
        ...
        <h3 className="uppercase font-bold mb-4 text-grey-600">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            I have been the sole frontend developer at Skillcrush for 3 years
            and because of that I have done a lot. I will try and highlight some
            of it below, but feel free to ask about details:
          </p>
          <ul className="list-outside list-disc pl-4">
            <li className="mb-4">
              Organized and implemented best practices around frontend codebase.
            </li>
            <li className="mb-4">
              Refactored and reorganized frontend assets to reduce number of
              resources required for page load.
            </li>
            <li className="mb-4">
              Leveraged WordPress REST API to standardize header and footer
              across three platforms
            </li>
            <li className="mb-4">
              Wrote backend, frontend, and designed internal tool to integrate
              purchase metrics and data between WordPress and HubSpot.
            </li>
            <li className="mb-4">
              Designed and built UI and sometime the backend for a number of
              internal tools including reports (transaction, churn, student
              progress), automations, and a url builder (this one was
              interesting).
            </li>
          </ul>
        </div>
        <div className="mb-12">
          ...
          <p className="mb-4">
            Throughout my entire career I've taken on contract projects creating
            websites from design to development to launch to maintenance and
            more. I just started calling the role I played Webmaster. Here are a
            few of the recent projects including the live site and the repo, if
            public, where the code lives:
          </p>
          <ul className="pt-2">
        ...
        <div className="mb-8">
          ...
          <p className="text-grey-600 mb-4">
            Although I don't work in this field professionally the lessons,
            skills, and experience gained from the program have been invaluable
