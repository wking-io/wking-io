...
var _wking_io$wking_io$Route$routeToString = function (page) {
	var pieces = function () {
		var _p0 = page;
		switch (_p0.ctor) {
			case 'Home':
...
var _wking_io$wking_io$Route$Login = {ctor: 'Login'};
var _wking_io$wking_io$Route$Root = {ctor: 'Root'};
var _wking_io$wking_io$Route$Home = {ctor: 'Home'};
var _wking_io$wking_io$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_evancz$url_parser$UrlParser$map,
			_wking_io$wking_io$Route$Home,
			_evancz$url_parser$UrlParser$s('')),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_wking_io$wking_io$Route$Login,
				_evancz$url_parser$UrlParser$s('login')),
			_1: {ctor: '[]'}
		}
	});
var _wking_io$wking_io$Route$fromLocation = function (location) {
	return _elm_lang$core$String$isEmpty(location.hash) ? _elm_lang$core$Maybe$Just(_wking_io$wking_io$Route$Root) : A2(_evancz$url_parser$UrlParser$parseHash, _wking_io$wking_io$Route$route, location);
};

var _wking_io$wking_io$Util_ops = _wking_io$wking_io$Util_ops || {};
_wking_io$wking_io$Util_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});

var _wking_io$wking_io$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _wking_io$wking_io$Main$viewPage = function (model) {
...
var _wking_io$wking_io$Main$Model = function (a) {
	return {currentPage: a};
};
var _wking_io$wking_io$Main$Login = {ctor: 'Login'};
var _wking_io$wking_io$Main$Home = {ctor: 'Home'};
var _wking_io$wking_io$Main$setRoute = F2(
	function (maybeRoute, model) {
		var _p1 = maybeRoute;
		if (_p1.ctor === 'Nothing') {
			return A2(
				_wking_io$wking_io$Util_ops['=>'],
				_elm_lang$core$Native_Utils.update(
					model,
					{currentPage: _wking_io$wking_io$Main$Home}),
				_elm_lang$core$Platform_Cmd$none);
		} else {
			switch (_p1._0.ctor) {
				case 'Home':
				...
				default:
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{currentPage: _wking_io$wking_io$Main$Login}),
						_elm_lang$core$Platform_Cmd$none);
			}
		}
	});
var _wking_io$wking_io$Main$update = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'SetRoute') {
			return A2(_wking_io$wking_io$Main$setRoute, _p2._0, model);
		} else {
			return {
				ctor: '_Tuple2',
				_0: model,
...
var _wking_io$wking_io$Main$Blank = {ctor: 'Blank'};
var _wking_io$wking_io$Main$initialPage = _wking_io$wking_io$Main$Blank;
var _wking_io$wking_io$Main$init = function (location) {
	return A2(
		_wking_io$wking_io$Main$setRoute,
		_wking_io$wking_io$Route$fromLocation(location),
		{currentPage: _wking_io$wking_io$Main$initialPage});
};
var _wking_io$wking_io$Main$LinkTo = function (a) {
	return {ctor: 'LinkTo', _0: a};
};
var _wking_io$wking_io$Main$viewMenu = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$button,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_wking_io$wking_io$Main$LinkTo('#home')),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_wking_io$wking_io$Main$LinkTo('#login')),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _wking_io$wking_io$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _wking_io$wking_io$Main$viewMenu,
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					ctor: '::',
					_0: _wking_io$wking_io$Main$viewPage(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _wking_io$wking_io$Main$SetRoute = function (a) {
	return {ctor: 'SetRoute', _0: a};
};
var _wking_io$wking_io$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	function (_p3) {
		return _wking_io$wking_io$Main$SetRoute(
			_wking_io$wking_io$Route$fromLocation(_p3));
	},
	{init: _wking_io$wking_io$Main$init, view: _wking_io$wking_io$Main$view, update: _wking_io$wking_io$Main$update, subscriptions: _wking_io$wking_io$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _wking_io$wking_io$Main$main !== 'undefined') {
    _wking_io$wking_io$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Route.Route":{"args":[],"tags":{"Home":[],"Root":[],"Login":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"LinkTo":["String"],"SetRoute":["Maybe.Maybe Route.Route"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
